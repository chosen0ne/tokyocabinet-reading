...
LIBRARYFILES = libtokyocabinet.a libtokyocabinet.9.11.0.dylib libtokyocabinet.9.dylib libtokyocabinet.dylib
...
CC = gcc
CPPFLAGS = -I. -I$(INCLUDEDIR) -I/Users/louzhenlin/include -I/usr/local/include -DNDEBUG -D_GNU_SOURCE=1 -D_REENTRANT -D__EXTENSIONS__ \
  -D_TC_PREFIX="\"$(prefix)\"" -D_TC_INCLUDEDIR="\"$(INCLUDEDIR)\"" \
  -D_TC_LIBDIR="\"$(LIBDIR)\"" -D_TC_BINDIR="\"$(BINDIR)\"" -D_TC_LIBEXECDIR="\"$(LIBEXECDIR)\"" \
  -D_TC_APPINC="\"-I$(INCLUDEDIR)\"" -D_TC_APPLIBS="\"-L$(LIBDIR) -ltokyocabinet -lbz2 -lz -lpthread -lm -lc \""
CFLAGS = -g -O2 -std=c99 -Wall -fPIC -fsigned-char -O2
LDFLAGS = -L. -L$(LIBDIR) -L/Users/louzhenlin/lib -L/usr/local/lib
CMDLDFLAGS = 
LIBS = -lbz2 -lz -lpthread -lm -lc 
